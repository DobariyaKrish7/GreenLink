...
const steps = [
    ...
    },
    {
        ...
        description: 'Explore a wide range of sustainable materials.'
    },
    {
        icon: <ShoppingBag className="h-8 w-8 text-green-600 mx-auto" />,
        title: 'Buy or Sell',
        description: 'Easily buy or list materials for sale.'
    },
    {
        icon: <TrendingUp className="h-8 w-8 text-green-600 mx-auto" />,
        title: 'Track & Grow',
        description: 'Track your trades and grow your impact.'
    }
];
